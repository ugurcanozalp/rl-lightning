...
class MSQL(pl.LightningModule):
    ...
    def training_step(self, batch, batch_index):
        ...
        prob_delta_observation = (- info_delta_observation).exp()
        model_loss = - prob_delta_observation.mean() - self.hparams.beta * model_entropy.mean()
